...
$query = "SELECT * FROM Budget.Bills WHERE Bill_owner = '$user' AND Bill_sec = '$section1' OR Bill_owner = '$user' AND Bill_sec = '$section2' OR Bill_owner = '$user' AND Bill_sec = '$section3' OR Bill_owner = '$user' AND Bill_sec = '$section4' OR Bill_owner = '$user' AND Bill_split = '1'";
// echo "$query_2 </br>";
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  if ( $bill_split == '1') { $bill_tmp = $bill_amnt; }
